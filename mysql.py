...
class Mysql:
    ...
    def insertData(self, BookType, identity, name, info , score, num , bookUrl, imgUrl):
        ...
        try:
            ...
            result = self.cur.execute(sql,(identity , name , info , score , num , BookType , bookUrl , imgUrl))
